// The audio-thread shell around bow-dsp.js, and deliberately nothing else.
//
...
// instruments/bow-dsp.js, and this file is the twenty lines that cannot be anything else - the
...
import { createBowEngine } from '../bow-dsp.js';
...
class BowProcessor extends AudioWorkletProcessor {
  constructor(options) {
    super();
    this.engine = createBowEngine(sampleRate, 6);
