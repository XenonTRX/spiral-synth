// The audio-thread shell around piano-dsp.js, and deliberately nothing else.
//
...
// instruments/piano-dsp.js, and this file is the twenty lines that cannot be anything else - the
...
import { createPianoEngine } from '../piano-dsp.js';
...
class PianoProcessor extends AudioWorkletProcessor {
  constructor(options) {
    super();
    this.engine = createPianoEngine(sampleRate, 10);
...
registerProcessor('piano', PianoProcessor);
